...
class sellsyConnect_curl {
	...
	private function __construct() {
		...
		$encoded_key = rawurlencode( $wp_sellsy->thfo_sellsy_options( 'WPIconsumer_secret' ) ).'&'.rawurlencode( $wp_sellsy->thfo_sellsy_options( 'WPIutilisateur_secret' ) );
		$oauth_params = array (
			'oauth_consumer_key' => $wp_sellsy->thfo_sellsy_options( 'WPIconsumer_token' ),
			'oauth_token' => $wp_sellsy->thfo_sellsy_options( 'WPIutilisateur_token' ),
